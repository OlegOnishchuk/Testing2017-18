...
public class Task3 {
    private static boolean FileCorect(String Path) {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String Path1 = "F:\\3 курс\\Testing software\\lab 5\\Lab 5\\Input.txt";
        String Path2 = "F:\\3 курс\\Testing software\\lab 5\\Lab 5\\PerHour.txt";
        String Path3 = "F:\\3 курс\\Testing software\\lab 5\\Lab 5\\Result.txt";
        boolean b1,b2;
